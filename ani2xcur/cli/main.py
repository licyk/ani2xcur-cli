...
def get_app() -> typer.Typer:
    ...
    cursor_cli.command(help="列出当前系统中已安装的鼠标指针")(list_cursor)
    cursor_cli.command(help="显示当前系统中设置的鼠标指针名称和大小")(get_current_cursor)
    ...
    image_magick_cli.command(help="安装 ImageMagick 到系统中")(install_image_magick)
    image_magick_cli.command(help="将 ImageMagick 从系统中卸载")(uninstall_image_magick)
